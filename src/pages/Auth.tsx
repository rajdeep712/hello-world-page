...
const Auth = () => {
      ...
      if (isLogin) {
        ...
        if (error) {
          ...
          toast({
            ...
            description: "Welcome to Basho! Your account has been created successfully.",
          });
        }
      }
    } catch (error) {
  ...
  return (
    <>
      <Helmet>
        <title>{isLogin ? "Sign In" : "Sign Up"} | Basho by Shivangi</title>
        <meta
          name="description"
          content="Sign in or create an account at Basho to manage your orders and workshop bookings."
        />
      </Helmet>
